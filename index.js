...
var htmlRead = fs.readFileSync(
  "02_-_Cribis_Approfondito_Snc/index.html",
  "utf8"
);
var base64ImageHeader = fs.readFileSync("./logo.png", "base64");
var base64ImageFooter = fs.readFileSync("./Rectangle.png", "base64");

const header = `<img src="data:image/png;base64,${base64ImageHeader}" class="imageHeader" style="padding-left: 45px; padding-bottom: 140px">`;
...
html_to_pdf.generatePdf(file, options).then((pdfBuffer) => {
  fs.writeFileSync("02_-_Cribis_Approfondito_Snc.pdf", pdfBuffer);
});
